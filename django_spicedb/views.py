...
from django_spicedb.models import HierarchyNode, HierarchyNodeRole
...
class HierarchyTreeView(TenantPermissionMixin, TemplateView):
    ...
    template_name = "django_spicedb/hierarchy_tree.html"
    required_permission = "view"
...
class NodeDetailView(TenantPermissionMixin, TemplateView):
    ...
    template_name = "django_spicedb/node_detail.html"
    required_permission = "view"
...
class InviteUserView(TenantPermissionMixin, View):
    ...
    required_permission = "manage"
    template_name = "django_spicedb/invite_user.html"
...
class PartialHierarchyTreeView(TenantPermissionMixin, View):
    ...
    template_name = "django_spicedb/partials/_hierarchy_tree.html"
...
class PartialNodeRolesView(TenantPermissionMixin, View):
    ...
    template_name = "django_spicedb/partials/_node_roles.html"
...
class PartialRoleFormView(TenantPermissionMixin, View):
    ...
    template_name = "django_spicedb/partials/_role_form.html"
    required_permission = "manage"
